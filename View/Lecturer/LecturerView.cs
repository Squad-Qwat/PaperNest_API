...
//            var result = _workspaceService.GetJoinedWorkspaces(_currentUser.Id);
...
//            var result = _workspaceService.GetWorkspaceById(workspaceId);
...
//                    {
//                        // Bergabung dengan workspace
//                        var joinResult = _workspaceService.JoinWorkspace(workspaceId, _currentUser.Id);
...
//            var result = _documentService.GetDocumentsByWorkspaceId(_currentWorkspace.Id);
...
//                var researchRequestService = new ResearchRequestService();
//                var requests = researchRequestService.GetAllRequests();
...
//            var researchRequestService = new ResearchRequestService();
//            var allRequests = researchRequestService.GetAllRequests();
...
//                // Tambahkan request
//                researchRequestService.AddRequest(title, abstractText, researcherName, document.User_id, version.Id);

//                // Dapatkan ID request yang baru dibuat
//                var newRequests = researchRequestService.GetAllRequests();
...
//            // Mulai review
//            researchRequestService.StartReview(requestId);

//            // Proses review
//            researchRequestService.ProcessReview(requestId, result, _currentUser.Id, comment);
